        ...
        <>
            <div className="gap-16">
                <div className="grid-4">
                    ...
                    <div className="card card-clickable" onClick={() => setTab("caddyfile")}>
                    ...
                    <div className="card card-clickable" onClick={() => setTab("tls")}>
                    ...
                    <div className="card card-clickable" onClick={() => setTab("routes")}>
                ...
                <div className="card">
                    ...
                    {!process ? (
                        ...
                        <div className="flex-between">
                            ...
                            <button className="btn btn-ghost btn--sm" onClick={() => setTab("metrics")}>Enable in Metrics →</button>
                        </div>
                    ) : (
                ...
                {status.online && status.servers?.length > 0 && (
                    <div className="card">
                        ...
                        {status.servers.map(s => (
                            <div className="server-row server-row--clickable" key={s.name} onClick={() => navigateToRoutes(s.name)}>
                                <div>
